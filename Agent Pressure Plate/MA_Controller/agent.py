...
class Agent:
	...
	def __init__(
		...
		self.critic_network = Q_network(in_channels=5, obs_input_dim=obs_input_dim, num_agents=self.num_agents, num_actions=self.num_actions, attention_type=self.attention_type, device=self.device).to(self.device)
		self.critic_network_old = Q_network(in_channels=5, obs_input_dim=obs_input_dim, num_agents=self.num_agents, num_actions=self.num_actions, attention_type=self.attention_type, device=self.device).to(self.device)
